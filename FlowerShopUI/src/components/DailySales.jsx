    ...
    <>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">
            September 18, 2025 • Data resets at midnight
          </p>
        </div>

        <div className="flex gap-2">
          <button
            className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition text-sm font-medium flex items-center"
          >
            Reset Day
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white shadow-sm border rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mt-2">Today's Total</p>
        </div>
        ...
        <div className="bg-white shadow-sm border rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mt-2">Items Sold Today</p>
        </div>
        ...
        <div className="bg-white shadow-sm border rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">₱493.83</p>
          <p className="text-sm text-gray-600 mt-2">Per Order Today</p>
        </div>
      </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between mt-2 text-sm">
                  <span className="text-gray-600">20 sold today</span>
